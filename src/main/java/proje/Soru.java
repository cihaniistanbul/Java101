...
public class Soru {
     ...
     * 1-) burada oncelikle urunun tanimlamasi  yapilir.  //pojoUrun
      ...
      miktar
      birim
      raf (6 adet fields mevcut)   (encapsulation olusturarak bir classta olustur.OOP'nin 3 temel prensibini uygula.Inheritance,polymorhphism ve encapsulation
     *
     * 2-) methodlar olusturacagiz.
     *      urunTanimlama   ==>  urunun ismi, ureticisi ve birimi girilecek. id  alınacak.  //MAP<id,pojoUrun>   RAF="-"ve Miktar=0 //arraylist veya MAP  Raf ve miktar default atansin veya null
     *
     *      urunListele     ==> tanimlanan urunler listelenecek. urunun adeti ve raf numarasi tanimlama yapilmadiysa default deger gorunsun. //ArrayList'le listeliyorduk ama printf ile daha duzenli yapabiliriz
     *     ///  printf(%10)
