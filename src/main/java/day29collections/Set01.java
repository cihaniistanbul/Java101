...
public class Set01 {
    public static void main(String[] args) {
        ...
        lhs.retainAll(ls);
        System.out.println(lhs); //[19, 13] -->retainAll kullandiktan sonra lhs bozuldu. LinkedHashSet teki farkli elemanlari siler
        ...
        //ts.add(null); -->TreeSet'lerde null eklenmez. Natural order'a gore dizdigi icin ekleyemiyor.
