...
public class ArrayList01 {
    public static void main(String[] args) {
        ...
        ages.add(12);
        ages.add(10);
        ages.add(1,656); //sayiyi 1 ve 12 arasina koymak istiyorum, indexle yapiyoruz
        ages.add(3,777); // 12 ile 10 arasina koyduk
        ages.add(888); // ad methodu bizim verdigimiz sirada sona ekliyor. en sona eklemek istedigim icin direk yazdik
